...
export const fooditemChefListReducer = (state = { fooditems: [] }, action) => {
  switch (action.type) {
    case FOODITEM_CHEF_LIST_REQUEST:
      return { loading: true, fooditems: [] };
    case FOODITEM_CHEF_LIST_SUCCESS:
      return { loading: false, fooditems: action.payload };
    case FOODITEM_CHEF_LIST_FAIL:
      return { loading: false, error: action.payload };
    default:
      return state;
  }
...
export const fooditemListByChefReducer = (state = { fooditems: [] }, action) => {
  switch (action.type) {
    case "FOODITEM_LIST_BY_CHEF_REQUEST":
      return { loading: true, fooditems: [] };
    case "FOODITEM_LIST_BY_CHEF_SUCCESS":
      return { loading: false, fooditems: action.payload };
    case "FOODITEM_LIST_BY_CHEF_FAIL":
      return { loading: false, error: action.payload };
    default:
      return state;
  }
